	...
	<ListStyled>
		...
		<ItemStyled>
			...
			>
				...
				<LegendIconStyled>WhatsApp</LegendIconStyled>
			</ContainerIconStyled>
		</ItemStyled>

		<ItemStyled>
			<ContainerIconStyled href="/joao.pdf" download="Joao-Paulo-Brune-CV.pdf">
				<IconStyled src={curriculumIcon} alt="Currículo" />
				<LegendIconStyled>Currículo</LegendIconStyled>
			</ContainerIconStyled>
		</ItemStyled>
	</ListStyled>
);
